...
#   plt.figure('2')
    ...
    Pk_cro*=Hx*Nx*Hy*Ny*Hz*Nz/(2*np.pi)**3*4*np.pi*(k_mag**3.)    # delta(k)^2
    Pk_gbt*=Hx*Nx*Hy*Ny*Hz*Nz/(2*np.pi)**3*4*np.pi*(k_mag**3.)    # delta(k)^2
    Pk_wig*=Hx*Nx*Hy*Ny*Hz*Nz/(2*np.pi)**3*4*np.pi*(k_mag**3.)    # delta(k)^2
