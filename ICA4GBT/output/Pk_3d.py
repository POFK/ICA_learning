...
data2=np.load('secA_15hr_41-80_pointcorr_clean_map_I_800_cleaned_5.npy')
data3=np.load('secA_15hr_41-80_pointcorr_clean_map_I_800_cleaned_10.npy')
data4=np.load('secA_15hr_41-80_pointcorr_clean_map_I_800_cleaned_20.npy')
#data5=np.load('secA_15hr_41-80_pointcorr_clean_map_I_800_cleaned_30.npy')
#data6=np.load('secA_15hr_41-80_pointcorr_clean_map_I_800_cleaned_100.npy')
################################################################################
