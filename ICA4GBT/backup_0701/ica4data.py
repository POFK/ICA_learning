...
map_clean_A=ica.Clean(data_A,label='a',freq=80,sigma=3,PLOT=1,ra=ra,dec=dec)
#plt.savefig('gbt_a_N100.eps')
map_clean_B=ica.Clean(data_A,label='b',freq=80,sigma=3,PLOT=1,ra=ra,dec=dec)
#plt.savefig('gbt_b_N100.eps')
map_clean_C=ica.Clean(data_A,label='c',freq=80,sigma=3,PLOT=1,ra=ra,dec=dec)
#plt.savefig('gbt_c_N100.eps')
map_clean_D=ica.Clean(data_A,label='d',freq=80,sigma=3,PLOT=1,ra=ra,dec=dec)
#plt.savefig('gbt_d_N100.eps')
plt.show()
#plt.close('all')
